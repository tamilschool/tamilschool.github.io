    ...
    styledDiv {
      ...
      for (i in listOf(0.5, 1, 1.5, 2)) {
        styledButton {
          ...
          css {
            val style =
              if (props.kuralScore.score[Group1RoundType.KURAL] == i) "btn-primary"
      ...
      for (i in listOf(0.5, 1, 1.5, 2)) {
        styledButton {
          ...
          css {
            val style =
              if (props.kuralScore.score[Group1RoundType.PORUL] == i) "btn-primary"
              else "btn-outline-primary"
            classes = mutableListOf("btn $style text-white btn-sm ml-1 mr-1")
            minWidth = 40.px
          }
      ...
      for (i in listOf(0.5, 1)) {
        styledButton {
          ...
          css {
            val style =
              if (props.kuralScore.score[Group1RoundType.CLARITY] == i) "btn-primary"
              else "btn-outline-primary"
            classes = mutableListOf("btn $style text-white btn-sm ml-1 mr-1")
            minWidth = 40.px
          }
